  ...
  return (
    ...
    >
      ...
      <div className="space-y-6">
        ...
        {/* <img src="Group1.svg" alt="Logo" className="mr-2 h-6 w-6 pt-2" /> */}
        TaskFlow</p>
        ...
        <button
          onClick={() => setSelectedStatus(selectedStatus === "Settings" ? null : "Settings")}
          className={clsx(
            "w-full px-4 py-2 text-left rounded-lg transition-colors",
            {
              "bg-purple-500 text-white hover:bg-purple-600": selectedStatus === "Settings",
              "hover:bg-purple-200": selectedStatus !== "Settings",
            }
          )}
        >
